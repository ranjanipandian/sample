...
ALLOWED_DOC_EXTENSIONS = ['.pdf', '.txt', '.doc', '.docx', '.csv', '.xls', '.xlsx']

def search_with_embeddings(query, search_types):
    """Perform semantic or keyword search with document filtering"""
    ...
    try:
        ...
        # Filter only allowed document files (exclude images, html, etc.)
        filtered_results = []
